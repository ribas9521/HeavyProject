    ...
    public void PickColor(Color color)
    {
        switch (_target)
        {
            case "Head":
                ...
                ccm.HeadColor = color.ToString();                
                break;
            case "Ears":
                Dummy.EarsRenderer.color = color;
                ccm.EarsColor = color.ToString();
                
                break;
            case "Hair":
                Dummy.HairRenderer.color = color;
                ccm.HairColor = color.ToString();                
                break;
            case "Eyebrows":
                Dummy.EyebrowsRenderer.color = color;
               
                ccm.EyebrowsColor = color.ToString();
                break;
            case "Eyes":
