...
namespace Assets.FantasyHeroes.Scripts
{
    ...
    public class CharacterEditor : MonoBehaviour
    {
        ...
        {            
            ReplaceSprite(ref Dummy.Head, SpriteCollection.Head, direction, "Head");
        }
        ...
        {
            ReplaceSprite(ref Dummy.Ears, SpriteCollection.Ears, direction, "Ears");
        }
        ...
        {
            ReplaceSprite(ref Dummy.Hair, Dummy.Helmet == null ? SpriteCollection.Hair : SpriteCollection.HairShort, direction, "Hair");
        }
        ...
        {
            ReplaceSprite(ref Dummy.Eyebrows, SpriteCollection.Eyebrows, direction, "Eyebrows");
        }
        ...
        {
            ReplaceSprite(ref Dummy.Eyes, SpriteCollection.Eyes, direction, "Eyes");
        }
        ...
        {
            Dummy.Beard = null;
            ReplaceSprite(ref Dummy.Mouth, SpriteCollection.Mouth, direction, "Mouth");
        }
        ...
        {
            Dummy.Mouth = null;
            ReplaceSprite(ref Dummy.Beard, SpriteCollection.Beard, direction, "Beard");
        }
        ...
        {
            ReplaceSprite(ref Dummy.Body, SpriteCollection.Body, direction, "Body");
        }
        ...
        {
            ReplaceSprite(ref Dummy.Helmet, SpriteCollection.Helmet, direction, "Helmet");
        }
        ...
        {
            ReplaceSprite(ref Dummy.Armor, SpriteCollection.Armor, direction, "Armor");
        }
        ...
        public void SetMeleeWeapon1H(int direction)
        {
            ...
            ReplaceSprite(ref Dummy.Weapon, SpriteCollection.MeleeWeapon1H, direction, "MeleeWeapon1H");
        ...
        public void SetMeleeWeapon2H(int direction)
        {
            ...
            ReplaceSprite(ref Dummy.Weapon, SpriteCollection.MeleeWeapon2H, direction, "MeleeWeapon2H");
            AnimationManager.Reset();
        }
        ...
        public void SetBow(int direction)
        {
            ...
            ReplaceSprite(ref Dummy.Bow, SpriteCollection.Bow, direction, "Bow");
            AnimationManager.Reset();
        }
        ...
        {
            Dummy.WeaponType = WeaponType.Melee1H;
            ReplaceSprite(ref Dummy.Shield, SpriteCollection.Shield, direction, "Shield");
            AnimationManager.Reset();
        }
        ...
        {            
            switch (_target)
            {
                case "Head":
                    ...
                    PlayerPrefs.SetString("HeadColor", color.ToString());
                    print("head" + color);                                   
                    break;
                case "Ears":
                    Dummy.EarsRenderer.color = color;
                    PlayerPrefs.SetString("EarsColor", color.ToString());
                    print("ears" + color);
                    break;
                case "Hair":
                    Dummy.HairRenderer.color = color;
                    PlayerPrefs.SetString("HairColor", color.ToString());
                    print("hair" + color);
                    break;
                case "Eyebrows":
                    Dummy.EyebrowsRenderer.color = color;
                    PlayerPrefs.SetString("EyebrowsColor", color.ToString());
                    print("eyebrows" + color);
                    break;
                case "Eyes":
                    Dummy.EyesRenderer.color = color;
                    PlayerPrefs.SetString("EyesColor", color.ToString());
                    break;
                case "Mouth":
                    Dummy.MouthRenderer.color = color;
                    PlayerPrefs.SetString("MouthColor", color.ToString());
                    break;
                case "Beard":
                    Dummy.BeardRenderer.color = color;
                    PlayerPrefs.SetString("BeardColor", color.ToString());
                    print("beard " + color);
                    break;
        ...
        private void ReplaceSprite(ref Texture2D texture, List<Texture2D> collection, int direction, string type)
        {
            var index = collection.IndexOf(texture) + direction;

            if ((type == "Hair" || type == "Eyebrows") && (index == -1 || index == collection.Count))
            {
